...
def allinone():
    ...
    os.system('cls & title [Fxskey Nuker] - Loading & mode 69,20')  
    ...
    async def menu():
        os.system(f'cls & mode 85,20 & title [Fxskey Nuker] - Connected: {client.user}')
        print(f'''
                                _____                       __                 
    _/ ____\_________  ___  _____|  | __ ____ ___.__.
    \   __\/  ___/\  \/  / /  ___/  |/ // __ <   |  |
    |  |  \___ \  >    <  \___ \|    <\  ___/\___  |
    ...
    try:
        ...
        RPC.update(details="Main Menu", large_image="Fxskey Nuker", small_image="Fxskey Nuker", large_text="Fxskey Nuker Nuker", start=time.time())
    except:
        pass
